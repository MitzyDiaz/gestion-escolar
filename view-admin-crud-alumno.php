                            ...
                            <div class="card-body">
                                ...
                                <div class='container'>
                                    <!-- INICIO BOTON AGREGAR-->
                                        <a href="view-admin-alumno-agregar.php"><button type="button" class="btn btn-primary btn-sm">
                                    ...
                                    <table id="tab_proyectos" width="100%" class='table'>
                                        ...
                                        $sentencia="SELECT id_usuario, id_curso, nombre, apaterno, amaterno,telefono,correo,boleta,usuario FROM control_escolar.usuario WHERE tipo_usuario = '3'";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="view-admin-alumno-modif.php?id_usuario=<?php echo $registro['id_usuario'];?>"><button type="button" class="btn btn-primary btn-sm">
...
<script> 
        function confirmar(id_usuario){
            if(confirm("¿Estas seguro que deseas borrar?")){
                window.location.href ="borrar-a.php?id_usuario="+id_usuario;
            }
        }
