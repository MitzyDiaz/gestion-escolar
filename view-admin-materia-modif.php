...
$id_materia = $_GET['id_materia'];
  ...
  $sentencia = "SELECT * FROM materias WHERE id_materia = '$id_materia'";
...
<div class="sidebar">
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="view-admin-materia-modif.php">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-header">
                                        <h3 class="title" style="margin-bottom: 10px !important;">Modificar Materias
                                        </h3>
                                        <hr style="border-top: 1px solid #2aa7df;">
                                </div>
                                <!--List Table-->
                                <div class='container'>
                                     <form action="updateMateria.php?id_materia=<?php echo $row['id_materia']; ?>" method="post">
                                      <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                          <label for="boleta">Nombre Materia</label>
                                          <input type="text" class="form-control" name="nombre_materia" id="nombre_materia" value="<?php echo $row['nombre_materia'];?>" minlength="5" maxlength="58" required>
                                        </div>
                                      </div>
                                      <!--SEGUNDA FILA-->
