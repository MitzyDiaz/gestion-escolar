...
<div class="sidebar">
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="view-admin-materia-agregar.php">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-header">
                                        <h3 class="title" style="margin-bottom: 10px !important;">Agregar Materias
                                        </h3>
                                        <hr style="border-top: 1px solid #2aa7df;">
                                </div>
                                <!--List Table-->
                               <div class='container'>
                                    <form action="insert-materia.php" method="post">
                                      <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                          ...
                                          <input type="text" class="form-control" name="nombre_materia" minlength="9" maxlength="10" required>
                                        </div>
                                      </div>
                                      <!--SEGUNDA FILA-->
