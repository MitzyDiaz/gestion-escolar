...
<div class="sidebar">
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="view-admin-profesor-modif.php">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-header">
                                  <h3 class="title" style="margin-bottom: 10px !important;">Modificar Profesor
                                  </h3>
                                  <hr style="border-top: 1px solid #2aa7df;">
                                </div>
                                <!--List Table-->
                                <div class='container'>
                                 <form action="updateProfesor.php?id_usuario=<?php echo $row['id_usuario']; ?>" method="POST">
                                    <div class="form-row">
